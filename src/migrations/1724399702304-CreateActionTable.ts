...
export class CreateActionTable1724399702304 implements MigrationInterface {
  name = 'CreateActionTable1724399702304';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`CREATE EXTENSION IF NOT EXISTS pg_trgm`);
    await queryRunner.query(
      `CREATE TABLE "action" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "id" character varying(8) NOT NULL, "title" character varying(40) NOT NULL, "logo" character varying(60) NOT NULL, "network" jsonb NOT NULL, "description" character varying(255) NOT NULL, "author" jsonb NOT NULL, "dApp" jsonb NOT NULL, "intent" jsonb NOT NULL, "intentionCount" integer NOT NULL DEFAULT '0', "interaction" integer NOT NULL DEFAULT '0', CONSTRAINT "PK_2d9db9cf5edfbbae74eb56e3a39" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
